...
class DmpiCrmPartner(models.Model):
    ...
    dist_channel_id = fields.Many2one("dmpi.crm.sale.dist.channel", "Distribution Channel ID")
    ...
    user_ids = fields.Many2many('res.users','dmpi_crm_partner_res_users_rel','partner_id','user_id', string='Users')
